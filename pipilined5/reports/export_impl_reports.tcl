...
# One path per endpoint.  This avoids -nworst replication hiding the next
# critical path family behind many equivalent paths to the same register.
report_timing \
    -delay_type max \
    -sort_by slack \
    -max_paths 200 \
    ...
    -input_pins \
    -nets \
    -file "${REPORT_DIR}/timing_unique_endpoints_max.rpt"
