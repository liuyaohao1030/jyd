...
module KLDJ_top(
    ...
    wire [`KLDJ_PC]              id_jal_redirect_pc;
    wire                         pc_redirect;
    wire [`KLDJ_PC]              pc_redirect_pc;
    ...
    assign id_jal_redirect = if_id_valid && (id_exu_op == 18'h1c);
    assign id_jal_redirect_pc = id_data1 + id_data2;
    ...
    assign ex_redirect = id_ex_valid && exu_jump_raw && (id_ex_exu_op != 18'h1c);
    assign pc_redirect = ex_redirect || id_jal_redirect;
    assign pc_redirect_pc = ex_redirect ? exu_jump_pc_raw :
                            id_jal_redirect_pc;
    ...
    assign tb_ex_jump = pc_redirect;
    assign tb_ex_jump_pc = pc_redirect ? pc_redirect_pc : `KLDJ_ZERO32;
