# Isolated FixTiming9 implementation run.  Keep this flow identical to
# FixTiming8C so the routed result is directly comparable at 175 MHz.
set script_dir [file dirname [file normalize [info script]]]
set root_dir [file normalize [file join $script_dir ".."]]
set rtl_dir [file join $root_dir "kldj.srcs2" "sources_1" "imports" "rtl"]
set out_dir [file join $script_dir "FixTiming9_impl"]
set timing_dir [file join $root_dir "Timing_info" "fixtiming9"]
...
foreach report_name [list timing_summary.rpt worst_paths.rpt utilization_hier.rpt high_fanout.rpt congestion.rpt] {
    file copy -force [file join $out_dir $report_name] [file join $timing_dir $report_name]
}
...
puts "FIX_TIMING9_WNS_NS=[get_property SLACK $worst_path]"
close_project
