...
#
# Script generated by Vivado on Sat Jul 11 14:06:41 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : div_gen_u32.sh
...
#
# Usage        : div_gen_u32.sh
#                div_gen_u32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                div_gen_u32.sh [-reset_run]
#                div_gen_u32.sh [-reset_log]
#                div_gen_u32.sh [-help]
#
...
#                script (type 'div_gen_u32.sh -help' for more information).
#
...
# script info
echo -e "div_gen_u32.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./div_gen_u32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.div_gen_u32 xil_defaultlib.glbl -o div_gen_u32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./div_gen_u32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key div_gen_u32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc div_gen_u32_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./div_gen_u32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: div_gen_u32.sh [-help]\n\
Usage: div_gen_u32.sh [-step]\n\
Usage: div_gen_u32.sh [-lib_map_path]\n\
Usage: div_gen_u32.sh [-reset_run]\n\
Usage: div_gen_u32.sh [-reset_log]\n\
Usage: div_gen_u32.sh [-keep_index]\n\
Usage: div_gen_u32.sh [-noclean_files]\n\n\
