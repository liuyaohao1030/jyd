...
#
# Script generated by Vivado on Sat Jul 11 14:09:33 +0800 2026
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DRAM_TDP.sh
...
#
# Usage        : DRAM_TDP.sh
#                DRAM_TDP.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DRAM_TDP.sh [-reset_run]
#                DRAM_TDP.sh [-reset_log]
#                DRAM_TDP.sh [-help]
#
...
# script info
echo -e "DRAM_TDP.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DRAM_TDP.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DRAM_TDP xil_defaultlib.DRAM_TDP xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DRAM_TDP -key {Behavioral:sim_1:Functional:DRAM_TDP} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DRAM_TDP.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DRAM_TDP.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DRAM_TDP.sh [-help]\n\
Usage: DRAM_TDP.sh [-step]\n\
Usage: DRAM_TDP.sh [-lib_map_path]\n\
Usage: DRAM_TDP.sh [-reset_run]\n\
Usage: DRAM_TDP.sh [-reset_log]\n\
Usage: DRAM_TDP.sh [-keep_index]\n\
Usage: DRAM_TDP.sh [-noclean_files]\n\n\
