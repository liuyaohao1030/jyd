...
module pipe_id_ex #(
    ...
    //   current EX/MEM            -> next MEM2 (selector becomes FWD_MEM2)
    //   current MEM2              -> next MEM/WB (legacy loads forward here;
    //                                  the optional registered-load bypass may
    //                                  instead make FWD_MEM2 legal)
