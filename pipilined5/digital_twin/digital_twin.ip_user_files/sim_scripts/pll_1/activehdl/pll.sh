...
#
# Script generated by Vivado on Mon Jul 13 15:27:34 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/DESKTOP/JYD/Source_code/BPU_FixTiming3/jyd/pipilined5/digital_twin/digital_twin.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
