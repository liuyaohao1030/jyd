...
#                script (type 'DRAM_TDP.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DRAM_TDP xil_defaultlib.glbl -o DRAM_TDP_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DRAM_TDP_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key DRAM_TDP_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DRAM_TDP_simv.daidir vcs_lib c.obj)
