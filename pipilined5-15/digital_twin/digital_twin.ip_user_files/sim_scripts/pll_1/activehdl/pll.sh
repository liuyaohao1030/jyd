...
#
# Script generated by Vivado on Wed Apr 29 12:07:34 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/DESKTOP/JYD/KDLJ_SRC/pipilined5/digital_twin/digital_twin.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
